...
export function Slice() {
  return (
    ...
    >
      <path
        d="M384.574 87.9604L17.4335 207.362M282.707 35.5321C334 50.6943 370.797 75.6086 382.546 84.2185C385.119 86.1044 386.552 89.1115 386.552 92.3019V258.587C386.552 260.962 385.023 263.067 382.764 263.801L22.179 381.059C18.6359 382.211 15 379.57 15 375.844V210.01C15 208.759 15.4126 207.543 16.174 206.55L161.349 17.2413C162.428 15.8349 164.098 15.0369 165.867 15.1338C178.03 15.7992 228.131 19.3994 282.707 35.5321Z"
        stroke="currentColor"
        strokeWidth="28.4291"
      />
    </svg>
